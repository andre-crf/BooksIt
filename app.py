...
def buscar_livros(termo):
    ...
    for item in data.get("items", []):
        ...
        # Gera link da Amazon usando ISBN (prioriza ISBN-13, depois ISBN-10)
        amazon_link = "#"
        if isbn_13 != "—":
            amazon_link = f"https://www.amazon.com.br/s?k={isbn_13}"
        elif isbn_10 != "—":
            amazon_link = f"https://www.amazon.com.br/s?k={isbn_10}"
